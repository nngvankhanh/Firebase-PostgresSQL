...
import com.firebase.postgresql.filter.CorsFilter;
import com.firebase.postgresql.filter.JwtTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .antMatchers(HttpMethod.POST, "/api/firebase-images/**").hasAuthority("ADMIN")
